    ...
    <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
      <div className='w-1/2 h-full flex flex-col justify-between font-["Neue_Montreal"] '>
        <div className='heading'>
            <h1 className='mt-10 uppercase text-[7vw] leading-none tracking-tighter font-semibold'>Eye-</h1>
            <h1 className='uppercase text-[7vw] leading-none tracking-tighter font-semibold'>Opening</h1>
        </div>
        <svg 
      ...
      <div className='w-1/2 '>
        <h1 className='mt-10 uppercase text-[6vw] font-["Neue_Montreal"] 
        leading-none tracking-tighter font-semibold'>Presentations</h1>
        <div className='dets  font-["Neue_Montreal" mt-10'>
            <a className="block text-xl font-light underline decoration-1 underline-offset-4" href="#">Instagram</a>
            <a className="block text-xl font-light underline decoration-1 underline-offset-4 " href="#">Facebook</a>
            <a className="block text-xl font-light underline decoration-1 underline-offset-4 " href="#">Behance</a>
            <a className="block text-xl font-light underline decoration-1 underline-offset-4" href="#">Twitter</a>
        </div>
      </div>
    </div>
  )
